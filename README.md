...
[![Ask Me Anything!](https://flat.badgen.net/static/Ask%20me/anything?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya "Ask Me Anything!")
[![GitHub license](https://flat.badgen.net/github/license/nikhilsundriya/apple-clone?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/blob/main/LICENSE "GitHub license")
[![Maintenance](https://flat.badgen.net/static/Maintained/yes?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/commits/main "Maintenance")
[![GitHub branches](https://flat.badgen.net/github/branches/nikhilsundriya/apple-clone?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/branches "GitHub branches")
[![Github commits](https://flat.badgen.net/github/commits/nikhilsundriya/apple-clone?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/commits "Github commits")
[![GitHub issues](https://flat.badgen.net/github/issues/nikhilsundriya/apple-clone?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/issues "GitHub issues")
[![GitHub pull requests](https://flat.badgen.net/github/prs/nikhilsundriya/apple-clone?icon=github&color=black&scale=1.01)](https://github.com/nikhilsundriya/apple-clone/pulls "GitHub pull requests")
...
[<img src="https://img.shields.io/badge/Buy_Me_A_Coffee-FFDD00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" width="200" />](https://www.buymeacoffee.com/nikhilsundriya "Buy me a Coffee")

## :rocket: Follow Me

[![Follow Me](https://img.shields.io/github/followers/nikhilsundriya?style=social&label=Follow&maxAge=2592000)](https://github.com/nikhilsundriya "Follow Me")
[![Tweet about this project](https://img.shields.io/twitter/url?style=social&url=https%3A%2F%2Ftwitter.com%2FTechnicalShubam)](https://twitter.com/intent/tweet?text=Check+out+this+amazing+app:&url=https%3A%2F%2Fgithub.com%2Fnikhilsundriya%2Fapple-clone "Tweet about this project")
## :books: Learn More
...
<a href="https://star-history.com/#nikhilsundriya/apple-clone&Timeline">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=nikhilsundriya/apple-clone&type=Timeline&theme=dark" />
  <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=nikhilsundriya/apple-clone&type=Timeline" />
  <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=nikhilsundriya/apple-clone&type=Timeline" />
</picture>
</a>
